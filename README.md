...
## Note
works without cuda option, some parts are not in the paper

Running original project
- python ./tasks/copy_task.py -optim rmsprop -batch_size 32 -mem_slot 64
...
- Modified copy_task.py. Default values changed to (-optim rmsprop -batch_size 32 -mem_slot 64).
